            ...
            <article class="accordion__item js-show-item-default" data-binding="expand-accordion-item">
                ...
                <svg width="52" height="47" viewBox="0 0 52 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="text">
                        ...
                        <p>Simplifiez vous la vie, utilisez <span class="bold">gratuitement</span> Tcheen pour gérer votre événement.<p>
                    </div>
                    <akar-icon name="chevron-down" id="icon1" stroke="3" color="#$black" size="20"> </akar-icon>
                </span>
